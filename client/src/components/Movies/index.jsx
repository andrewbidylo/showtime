...
import MoviesTable from '../MoviesTable/index';
...
class Movies extends React.Component {
  ...
  render() {
    ...
    const { classes, parsedMovies } = this.props;
    ...
    return (
      <>
        ...
        <div className={classes.wrapper}>
          <MoviesTable onOpen={this.handleClickOpen} onClose={this.handleClose} parsedMovies={parsedMovies}/>
...
export default addStyles(Movies)